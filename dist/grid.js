...
exports.COLUMNS_TO_LEFT = -1;
exports.COLUMNS_TO_RIGHT = 1;
...
var SlickGrid = (function () {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        // Events
        this.onScroll = new core_1.Event();
        this.onSort = new core_1.Event();
        this.onHeaderMouseEnter = new core_1.Event();
        this.onHeaderMouseLeave = new core_1.Event();
        this.onHeaderContextMenu = new core_1.Event();
        this.onSubHeaderContextMenu = new core_1.Event();
        this.onHeaderClick = new core_1.Event();
        this.onHeaderCellRendered = new core_1.Event();
        this.onHeaderColumnDragStart = new core_1.Event();
        this.onHeaderColumnDrag = new core_1.Event();
        this.onHeaderColumnDragEnd = new core_1.Event();
        this.onHeadersCreated = new core_1.Event(); // Throws once after all headers and subheaders are created (or re-created)
        this.onBeforeHeaderCellDestroy = new core_1.Event();
        this.onSubHeaderCellRendered = new core_1.Event();
        this.onBeforeSubHeaderCellDestroy = new core_1.Event();
        this.onMouseEnter = new core_1.Event();
        this.onMouseLeave = new core_1.Event();
        this.onClick = new core_1.Event();
        this.onDblClick = new core_1.Event();
        this.onContextMenu = new core_1.Event();
        this.onBeforeKeyDown = new core_1.Event();
        this.onKeyDown = new core_1.Event();
        this.onAddNewRow = new core_1.Event();
        this.onValidationError = new core_1.Event();
        this.onViewportChanged = new core_1.Event();
        this.onRender = new core_1.Event();
        this.onInvalidate = new core_1.Event();
        this.onColumnsReordered = new core_1.Event();
        this.onColumnsResized = new core_1.Event();
        this.onColumnsChanged = new core_1.Event();
        this.onCellChange = new core_1.Event();
        this.onBeforeEditCell = new core_1.Event();
        this.onBeforeCellEditorDestroy = new core_1.Event();
        this.onBeforeDestroy = new core_1.Event();
        this.onActiveCellChanged = new core_1.Event();
        this.onActiveCellPositionChanged = new core_1.Event();
        this.onActiveRowChanged = new core_1.Event();
        this.onDragInit = new core_1.Event();
        this.onDragStart = new core_1.Event();
        this.onDrag = new core_1.Event();
        this.onDragEnd = new core_1.Event();
        this.onSelectedRowsChanged = new core_1.Event();
        this.onCellCssStylesChanged = new core_1.Event();
        // settings
        this.defaults = {
            ...
            autoHeight: false,
            editorLock: new core_1.EditorLock(),
            ...
            defaultFormatter: defaultFormatter_1.defaultFormatter,
        ...
        this.debouncedUpdateAntiscroll = lodash_1.debounce(function () { return _this.updateAntiscroll(); }, 500);
    ...
    SlickGrid.prototype.rowsToRanges = function (rows) {
        ...
        for (var i = 0; i < rows.length; i++) {
            ranges.push(new core_1.Range(rows[i], 0, rows[i], lastCell));
        }
        return ranges;
    };
...
// constants
SlickGrid.COLUMNS_TO_LEFT = exports.COLUMNS_TO_LEFT;
SlickGrid.COLUMNS_TO_RIGHT = exports.COLUMNS_TO_RIGHT;
